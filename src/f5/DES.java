...
public class DES {
    ...
    // https://youtu.be/qgofSZFTuVc?t=610



    // asdksadjsakdja sdj|  asdkljsadkjasdk sajd | asdksajdksadjsakd| asdkjaskdjasdkd |
...
// keys 56 bit => 2**56 = 7* 10^16  / 4* 10^10 = 1000_000 sec = 277 часов 46 минут 40 == 11 дней  в 90стих за 2 дня